...
import bgImage from "../../../assets/ground.jpg"; // Example background image
...
const Sports = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row h-auto bg-primary font-poppins m-4">
      ...
      <motion.div
        className="w-full md:w-1/4 p-6 md:p-12 flex flex-col justify-center items-left"
        initial={{ opacity: 0, x: -100 }}
        whileInView={{ opacity: 1, x: 0 }}
        transition={{ duration: 1 }}
        viewport={{ once: true }}
      >
        <h2 className="text-2xl md:text-3xl font-semibold mb-4 text-left text-secondary">SPORTS & ENTERTAINMENT</h2>
      ...
      <motion.div
        className="w-full md:w-3/4 h-auto p-6 md:p-12 bg-cover bg-center relative"
