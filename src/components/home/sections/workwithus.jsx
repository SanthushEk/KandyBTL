  ...
  return (
    <div className="flex flex-col lg:flex-row h-auto bg-primary font-futura m-2">
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 text-white font-futura border-2 border-gray-500 p-5 lg:pt-24 rounded-sm mb-6 h-full">
          {/* Title and Subtitle */}
            ...
            <ul className="space-y-4">
              <li className="flex items-center space-x-3 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-lg">
                    We prioritize eco-friendly practices in every step of our
                    process.
                  </p>
                </div>
              </li>
              <li className="flex items-center space-x-5 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-lg">
                    We ensure timely delivery of projects without compromising
                    quality.
                  </p>
                </div>
              </li>
              <li className="flex items-center space-x-5 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-lg">
                    We leverage the latest technologies for innovative
                    solutions.
                  </p>
                </div>
              </li>
              <li className="flex items-center space-x-5 mb-6">
                ...
                <div>
                  ...
                  <p className="text-sm md:text-lg">
                    We bring fresh, creative ideas to drive your brand forward.
                  </p>
                </div>
              </li>
            </ul>
      ...
      >
        <div className="relative z-10 mb-6">
          <h1 className="text-4xl tracking-wider font-bold text-secondary mb-4">
            Kandy Sri Lanka
          </h1>
          <p className="text-lg tracking-wide text-secondary mb-6">
            Kandy BTL's expansive outdoor advertising network covers a wide
            range of impactful platforms, including roadside billboards, bus
            shelter ads, roundabout and iconic locations branding, street
            marketing as well as underpass, overpass, and railway station
            advertising. Our reach extends into the heart of local communities
            and bustling high streets across Kandy, effectively engaging both
            local and foreign audiences alike. Whether it's tourism destinations
            or high-traffic urban areas, our strategic placements ensure maximum
            visibility as people move through the region.
          </p>
          {/* Right Image Card */}
          ...
          <h2 className="text-2xl tracking-wide text-secondary font-semibold mb-4">
            10 Years of Undefeated Successes
          </h2>
